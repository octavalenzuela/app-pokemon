...
const GetInfo = () => {
 ...
 const closeModal = () => setIsSelected(null)
  ...
  return(
    <>
     <h1
      style={{ textAlign: "center",margin: "20px auto", // esto lo centra horizontal
    padding: "10px" }}>Buscador de Pokemones</h1>
      <input type='text'
        ...
        style={{
        display: "block",
        margin: "50px auto", // esto lo centra horizontal
        padding: "10px",
        borderRadius: "8px",
        width: "250px",
        textAlign: "center",
      ...
      <img 
        ...
        alt={pokemon.name} 
        style={{ fontFamily:'Lucida Sans', width: "100%", height: "150px", objectFit: "contain", margin: "10px" }}
      />
